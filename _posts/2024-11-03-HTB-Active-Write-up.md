---
layout: post
title:  HTB Active Write-up 2024
...
Using the command above, we are indeed able to successfully carry out our Kerberoasting attack and get the hash for the Administrator user:
```shell
